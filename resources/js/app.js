...
Vue.prototype.$isDebug = () => (process.env.MIX_APP_DEBUG === 'true' || process.env.MIX_APP_DEBUG === true) || (store.state.user && window.$permission.$checkPermission('*'));
