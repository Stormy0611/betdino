        ...
        <div class="row page-title">
            <div class="col-md-12">
                <div class="float-right">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#create" v-if="$checkPermission('promocodes', 'create')">Create</button>
                    <button class="btn btn-danger" onclick="axios.post('/admin/promocode/remove_inactive').then(() => window.location.reload())" v-if="$checkPermission('promocodes', 'delete')">Cleanup</button>
                </div>
                                ...
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item pr-2">
                                        <a @click="remove(code._id)" href="javascript:void(0)" class="text-muted d-inline-block" data-toggle="tooltip" data-placement="top" title="" data-original-title="Remove"
                                           v-if="$checkPermission('promocodes', 'delete')">
                                            Remove
                                        </a>
                                    </li>
                                </ul>
