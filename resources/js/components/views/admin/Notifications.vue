    ...
    <div>
        <div class="row page-title">
            <div class="col-md-12">
                <div class="float-right">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#create_standalone" v-if="$checkPermission('notifications', 'create')">Send notification to all users</button>
                    <!--
        ...
        <div class="row" v-if="data.global">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <a href="javascript:void(0)" class="btn btn-primary btn-sm float-right" v-if="$checkPermission('notifications', 'create')" data-toggle="modal" data-target="#create_global">
                            Create
                        </a>
                            ...
                            <table class="table table-hover table-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr v-for="notification in data.global">
                                        ...
                                        <td style="width: 10%"><button class="btn btn-danger btn-sm" @click="remove(notification._id)" v-if="$checkPermission('notifications', 'delete')">Remove</button></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="fal fa-exclamation-triangle" type="text" value="fal fa-exclamation-triangle" id="icon_global" v-model="icon">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
