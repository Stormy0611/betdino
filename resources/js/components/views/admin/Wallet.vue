                            ...
                            <div v-for="withdraw in withdraws.withdraws" :class="`col-sm-6 col-md-6 col-lg-4 ${withdraw.user.vipLevel === 5 ? 'order-1' : 'order-2'}`">
                                <div class="card" :style="withdraw.user.vipLevel === 5 ? 'border: 1px solid #00fffb' : ''">
                                    <div class="card-body p-3">
                                            ...
                                            <div class="col-12">
                                                <div class="media">
                                                    <div class="media-body">
                                                        ...
                                                        <div v-if="withdraw.withdraw.cpfType">CPF type: {{ withdraw.withdraw.cpfType }}</div>
                                                        <div v-if="withdraw.withdraw.whatsApp">WhatsApp: {{ withdraw.withdraw.whatsApp }}</div>
                                                        <div v-if="withdraw.withdraw.cpf">CPF: {{ withdraw.withdraw.cpf }}</div>
                                                        <div v-if="withdraw.withdraw.chavePix">Chave PIX: {{ withdraw.withdraw.chavePix }}</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                        ...
                                        <div class="row mt-3 text-center" v-if="$checkPermission('withdraws', 'edit')">
                                            <div class="col">
