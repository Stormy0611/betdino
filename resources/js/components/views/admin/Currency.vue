<template>
    <div>
        <div class="row page-title">
            <div class="col-md-12">
                <h4 class="mb-1 mt-1">Wallet</h4>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row" v-if="data && $checkPermission('wallet', 'edit')">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                ...
                <div class="col-12 col-sm-6 col-md-4" v-for="currency in currencies" v-if="currency.balance">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <small>Use $ or R$ prefix to set auto conversion (example: $100, R$100)</small>
                            ...
                            <div class="mt-2" v-if="data.options && data.options[currency.id] && $checkPermission('wallet', 'edit')">
