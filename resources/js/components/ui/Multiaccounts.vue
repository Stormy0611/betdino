    ...
    <div class="media" v-if="info">
        <div class="media-body">
            <h6 class="font-weight-normal mt-0">
                ...
                <div v-if="info.same_register_hash.length <= 1 && info.same_login_hash.length <= 1 && info.same_register_ip.length <= 1 && info.same_login_ip.length <= 1">No secondary accounts detected</div>
                <template v-else>
