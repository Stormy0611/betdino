<template>
    <div class="container" v-if="currencies">
        <div class="live">
            <div class="header">
                    ...
                    <table class="live-table" v-else>
                        ...
                        <tbody class="live_games">
                            <tr v-for="game in lastGames">
                                ...
                                <th>
                                    <div>
                                        <a href="javascript:void(0)" @click="game.user.private_bets !== true || (isGuest ? false : $checkPermission('ignore_privacy')) ? openUserModal(game.user._id) : false">
                                            <span v-if="game.user.private_bets && (isGuest ? true : $checkPermission('ignore_privacy'))"><icon icon="fad fa-user-secret mr-1"></icon> {{ $t('general.bets.hidden_name') }}</span>
                                            <span v-else>
                                ...
                                <th data-highlight class="d-none d-md-table-cell">
                                    <div class="payout" :class="game.game.multiplier > 0 ? 'win' : 'lose'">{{ (game.game.status === 'win' || game.game.multiplier < 1 ? game.game.multiplier : 0).toFixed(2) }}x</div>
                                </th>
                                <th>
