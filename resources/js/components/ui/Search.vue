<template>
    <div class="search-modal" :class="show ? 'show' : ''">
        <div class="container">
            <div class="input">
                <input id="searchInput" v-model="search" placeholder="Search...">
                <icon icon="fal fa-search" class="icon"></icon>
                <div @click="show = false" class="close"><icon icon="fal fa-times" class="close"></icon></div>
            </div>
