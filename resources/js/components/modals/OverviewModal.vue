                            ...
                            share(type) {
                                ...
                                switch (type) {
                                   ...
                                   case "chat":
                                       ...
                                       break;
                                   case "twitter":
                                       window.open(`https://twitter.com/intent/tweet?hashtags=BetDino.io&text=${this.$i18n.t('general.share_text')}&url=${share_url}`, '_blank');
                                       break;
                                   case "telegram":
                        ...
                        template: `
                            <div>
                                ...
                                <div class="overview-player" v-if="response">
                                    ...
                                    <a href="javascript:void(0)" @click="close(); openUserModal(response.info.user)" v-if="!response.user.private_bets">
                                       {{ response.user.name }}
                                    </a>
